...
async def register_with_eureka():
    try:
        ...
        app_name = os.getenv('APP_NAME', 'service-scrapping')
        ...
        await eureka_client.init_async(
            ...
            metadata={
                ...
                "securePort": "443",
                "statusPageUrl": f"http://{app_host}:{app_port}/api/service-scrapping/info",
                "healthCheckUrl": f"http://{app_host}:{app_port}/api/service-scrapping/health"
            }
        )
